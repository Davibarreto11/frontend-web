...
<Table className="">
  <TableHeader>
    <TableRow>
      <TableHead className="w-[100px]">Defeito</TableHead>
      <TableHead className="w-[100px]">Peças</TableHead>
      <TableHead className="w-[100px]">Observações</TableHead>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell className="w-25">Em Andamento</TableCell>
    </TableRow>
